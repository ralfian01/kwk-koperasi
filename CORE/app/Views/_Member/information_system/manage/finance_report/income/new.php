    ...
    <div class="form_target content_box">
        <div class="tx_field1">
            <div class="input_label">
                <label for="amount">
                    Jumlah pemasukan <span style="color: red">*</span>
                </label>
            </div>
        ...
        <div class="tx_field1 mt2">
            ...
            <div class="input_item">
                <textarea name="description" id="description" placeholder="Cth: Pemasukan"></textarea>
            </div>
        </div>
                            ...
                            $.modalBox
                                ...
                                .open({
                                    onConfirm: (trigger, element) => {
                                        ...
                                        let url = $.makeURL.api().addPath('manage/finance_report/income').href;
