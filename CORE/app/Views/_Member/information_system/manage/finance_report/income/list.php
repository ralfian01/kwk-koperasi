...
<div class="content_box">
    ...
    <div class="initial mb1c5">
        <div class="title flex y_start x_between flex_gap1">
            ...
            <div class="flex_child fits">
                <a href="<?= member_url('manage/finance_report/income/new'); ?>" class="button1 nwrap">
    ...
    <?php if (isset($financeReportIncomeList) && count($financeReportIncomeList) >= 1) : ?>
        ...
        <div class="printable">
            ...
            <table class="table1">
                ...
                <tbody>
                    <?php $index = 1; ?>
                    <?php foreach ($financeReportIncomeList as $list) : ?>
                        ...
                        <tr class="<?= $index % 2 == 0 ? 'even' : 'odd'; ?>">
                            ...
                            <?php if (in_array('FINANCE_REPORT_MANAGE_DELETE', $auth['privilege'])) : ?>
                                ...
                                <td class="flex y_start flex_gap1">
                        ...
                        $.modalBox
                            ...
                            .open({
                                onConfirm: (trigger, element) => {
                                    ...
                                    let url = $.makeURL.api().addPath('manage/finance_report/income/' + id).href;
